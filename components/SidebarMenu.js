    ...
    <>
        ...
        <div className={`py-3 px-4 bg-${sidebarTheme}`}>
          <Row type="flex" align="middle" justify="space-around">
            <img src="/static/images/main-logo.svg" style={{marginTop: 25, width: 170, marginLeft: 0}} /> 
          </Row>
        </div>
        <Divider
          className={`m-0`}
    ...
    <>
      ...
      <Inner>
        {!state.mobile && ( 
            ...
            > 
              <div css={`
                background: url(/static/images/background-sidebar.svg), linear-gradient(175.42deg, #0033EA 11.63%, #013F9F 101.04%);
