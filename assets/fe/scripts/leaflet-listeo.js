$(document).ready(function() {
    if (document.getElementById("map") !== null) {
        ...
        var locations = [
            ...
            [locationData('listings-single-page.html', 'images/listing-item-04.jpg', 'ADAW', '2726 Shinn Street, New York', '5.0', '31'), 42.079386, -72.519478, 7, '<i class="im im-icon-Hamburger"></i>'],
        ];
