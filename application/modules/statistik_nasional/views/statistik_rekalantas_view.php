        ...
        <div class="row mt-5">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="section-headline text-center mb-4">
                    <h2>Rangking Rekalantas</h2>
                </div>
            </div>
        </div>
        <div id="cardrekalantas"></div>
    </div>
</div>
...
<script>
    ...
    function getCardRekalantas() {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>executive/statistik_executive/getCardRekalantas",
