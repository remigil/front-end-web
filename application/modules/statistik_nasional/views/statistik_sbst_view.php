<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-6 text-end align-self-center">
            <a href="<?= ENV_API_BASE_URL ?>v1/laporan_harian/sbst" type="button" button class="btn btn-outline-primary btn-lg" style="width: 200px; border-color:#0007D8;">Export Laporan</a>
    ...
    <div class="card mt-5 p-1 shadow" style="border-radius:36px !important;">
        <div class="row m-2">
            <div class="col-sm-4 col-md-5 align-self-center">
                <h2>DATA <span style="text-transform:uppercase ; color:#2e93e6">Fasmat SBST <span style="color:#000;">Nasional</span></span> </h2>
            </div>
                            ...
                            <div class="card-body p-1">
                                <div class="row justify-content-between align-items-center" style="height: 80px;">
                                    ...
                                    <div class="col-md-5 float-end">
                                        <h1 class="text-center mb-0" style="color:#464646; font-size:25px; color:#2e93e6;" id="sbstThisDay"></h1>
                                        <p class="text-center mb-0">Fasmat SBST</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card p-1 mt-2 mb-2" style="border-radius: 20px !important; border-color:#D9D9D9">
                            <div class="card-body p-1">
                                <div class="row justify-content-between align-items-center" style="height: 80px;">
                                    ...
                                    <div class="col-md-5 float-end">
                                        <h1 class="text-center mb-0" style="color:#464646; font-size:25px; color:#2e93e6;" id="sbstThisMonth"></h1>
                                        <p class="text-center mb-0">Fasmat SBST</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card p-1 mt-2 mb-2" style="border-radius: 20px !important; border-color:#D9D9D9">
                            <div class="card-body p-1">
                                <div class="row justify-content-between align-items-center" style="height: 80px;">
                                    ...
                                    <div class="col-md-5 float-end">
                                        <h1 class="text-center mb-0" style="color:#464646; font-size:25px; color:#2e93e6;" id="sbstThisYear"></h1>
                                        <p class="text-center mb-0">Fasmat SBST</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-12">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                <h5>Ranking Polda Data Fasmat SBST Tertinggi <?= date('d M Y'); ?></h5>
                                <div class="card shadow-sm">
                                    <table class="table table-bordered table-hover" id="tableSbstDay">
                                        <thead style="background-color:#007DD8; color:#fff;">
                                            <tr class="text-center">
                                                <th scope="col">No</th>
                                                <th scope="col">Polda</th>
                                                <th scope="col">Fasmat SBST</th>
                                            </tr>
                                        </thead>
                                        <tbody id="tbody-sbstDay">
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                <h5>Ranking Polda Data Fasmat SBST Tertinggi <?= date('M Y'); ?></h5>
                                <div class="card shadow-sm">
                                    <table class="table table-bordered table-hover" id="tableSbstMonth">
                                        <thead style="background-color:#007DD8; color:#fff;">
                                            <tr class="text-center">
                                                <th scope="col">No</th>
                                                <th scope="col">Polda</th>
                    ...
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                <h5>Ranking Polda Data Fasmat SBST Tertinggi <?= date('Y'); ?></h5>
                                <div class="card shadow-sm">
                                    <table class="table table-bordered table-hover" id="tableSbstYear">
                                        <thead style="background-color:#007DD8; color:#fff;">
                                            <tr class="text-center">
                                                <th scope="col">No</th>
                                                <th scope="col">Polda</th>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                let polda_sbst = result.data.polda_walpjr
                // Chart Wal pjr Lalu Lintas

                var chart = {
                    series: [{
                        name: '<h6>Total Fasmat SBST</h6>',
                        type: 'column',
                        data: polda_sbst,
                        color: "#11347A"
                    }],
        ...
        topSbstDay(yesterday);
        topSbstMonth(firstDayMonth, lastDayMonth);
        topSbstYear(firstDay, lastDay)

        sbst_daily(yesterday, firstDayMonth, lastDayMonth, firstDay, lastDay)

        SbstlineChart(seven_daysAgo, yesterday)
        jam();
    })
    ...
    $('#limit_showData').on('change', function() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                let polda_id = result.data.polda_id
                let polda_name = result.data.polda_name
                let polda_sbst = result.data.walpjr
    ...
    function sbst_daily(yesterday, firstDayMonth, lastDayMonth, firstDay, lastDay) {
        $.ajax({
            type: "POST",
            ...
            success: function(result) {
                console.log(result);
                $("#overlay").fadeOut(300);
                $('#sbstThisDay').text(result.thisDay)
                $('#sbstThisMonth').text(result.thisMonth)
                $('#sbstThisYear').text(result.thisYear)
    ...
    function ButtonFilter() {
        ...
        if ((start_date != '' && end_date == '') || (start_date == '' && end_date != '')) {
            ...
            SbstlineChart(start_date, end_date)
        }
    }

    function SbstlineChart(seven_daysAgo, yesterday) {
    ...
    function topSbstDay(yesterday) {
        $.ajax({
            ...
            success: function(result) {
                ...
                $('#tbody-sbstDay').html(table);
                <?php $mobile = detect_mobile();
                if ($mobile === true) { ?>

                    $('#tableSbstDay').DataTable({
                        responsive: true,
    ...
    function topSbstMonth(firstDayMonth, lastDayMonth) {
        $.ajax({
            type: "POST",
            ...
            success: function(result) {
                ...
                $('#tbody-sbstMonth').html(table);
                <?php $mobile = detect_mobile();
                if ($mobile === true) { ?>

                    $('#tableSbstMonth').DataTable({
                        responsive: true,
    ...
    function topSbstYear(firstDay, lastDay) {
        $.ajax({
            type: "POST",
            ...
            success: function(result) {
                ...
                $('#tbody-sbstYear').html(table);
                <?php $mobile = detect_mobile();
                if ($mobile === true) { ?>

                    $('#tableSbstYear').DataTable({
                        responsive: true,
