 ...
 <script>
     $(document).ready(function() {
         ...
         topLakaDay(yesterday, yesterday);
     ...
     function ButtonFilterOnTable(type) {
         ...
         if (type === 'day') {
             ...
             topLakaDay(start_date, end_date);
             $('#modalLabelDay').text(`Detail Kecelakaan Tanggal ${moment(start_date).format('DD MM YYYY')} s.d ${moment(end_date).format('DD MM YYYY')} Seluruh Polda`)
         } else if (type === 'month') {
             ...
             topLakaMonth(start_date, end_date);
             $('#modalLabelMonth').text(`Detail Kecelakaan Bulan ${moment(start_date).format('MM YYYY')} s.d ${moment(end_date).format('MM YYYY')} Seluruh Polda`)
         } else if (type === 'year') {
             ...
             topLakaYear(start_date, end_date)
             $('#modalLabelYear').text(`Detail Kecelakaan Tahun ${moment(start_date).format('YYYY')} s.d ${moment(end_date).format('YYYY')} Seluruh Polda`)
         }
         //  $.ajax({
         //      url: "<?php echo base_url(); ?>executive/statistik_executive/getDetailStatistikLakalantas",
         //      data: {
     ...
     function topLakaDay(start_date, end_date) {
         $.ajax({
             type: "POST",
