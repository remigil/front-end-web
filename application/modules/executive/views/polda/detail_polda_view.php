...
<body>
	...
	<div class="filter p-3" style="background-color: #2E2E2E; height:125px;" >
						<div class="container" >
...
<div class="row justify-content-center mt-5">
	<div class="col-md-1 d-flex justify-content-center">
		<img src="<?= base_url('assets/polda_metro_jaya.png') ?>" alt="img-polda" width="100px">
	</div>
	<div class="col-md-7 align-self-center">
		<h1 style="color:#007DD8 ; text-transform:uppercase;">Polda Metro Jaya</h1>
