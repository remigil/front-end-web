...
<script>
    ...
    function WalpjrlineChart(id) {

        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>executive/statistik_polda_executive/getBrandWalpjr/" + id,
    ...
    function topWalpjrDay(id) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>executive/statistik_polda_executive/getTopWalpjr/" + id,
            dataType: "JSON",
    ...
    function WalpjrpieChart(id) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>executive/statistik_polda_executive/getTypeWalpjr/" + id,
            dataType: "JSON",
            success: function(results) {
                //  console.log(results);
