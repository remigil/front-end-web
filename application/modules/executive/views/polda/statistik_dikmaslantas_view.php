...
<script>
    $(document).ready(function() {
        ...
        dikmas_daily(yesterday, firstDayMonth, lastDayMonth, firstDay, lastDay, id)
    ...
    function dikmas_daily(yesterday, firstDayMonth, lastDayMonth, firstDay, lastDay, id) {
        $.ajax({
            type: "POST",
    ...
    function DikmaslineChart(seven_daysAgo, yesterday, id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>executive/Statistik_executive/getLineDikmas/" + id,
            data: {
