     ...
     <div class="card mt-5 p-1 shadow" style="border-radius:36px !important;">
         <div class="row m-2">
             <div class="col-sm-4 col-md-5 align-self-center">
                 <h2>DATA <span style="text-transform:uppercase ; color:#2e93e6">Anev <span style="color:#000;">Polda&nbsp;<?= $data['poldaid']['name_polda']; ?></span></span> </h2>
             </div>
                             ...
                             <div class="card-body p-1">
                                 <div class="row justify-content-between align-items-center" style="height: 80px;">
                                     ...
                                     <div class="col-md-5 float-end">
                                         <h1 class="text-center mb-0" style="color:#464646; font-size:25px; color:#2e93e6;" id="AnevThisDay"></h1>
                                         <p class="text-center mb-0">Anev</p>
                                     </div>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="card p-1 mt-2 mb-2" style="border-radius: 20px !important; border-color:#D9D9D9">
                             <div class="card-body p-1">
                                 <div class="row justify-content-between align-items-center" style="height: 80px;">
                                     ...
                                     <div class="col-md-5 float-end">
                                         <h1 class="text-center mb-0" style="color:#464646; font-size:25px; color:#2e93e6;" id="AnevThisMonth"></h1>
                                         <p class="text-center mb-0">Anev</p>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <div class="card p-1 mt-2 mb-2" style="border-radius: 20px !important; border-color:#D9D9D9">
                             <div class="card-body p-1">
                                 <div class="row justify-content-between align-items-center" style="height: 80px;">
                                     ...
                                     <div class="col-md-5 float-end">
                                         <h1 class="text-center mb-0" style="color:#464646; font-size:25px; color:#2e93e6;" id="AnevThisYear"></h1>
                                         <p class="text-center mb-0">Anev</p>
                                     </div>
                                 </div>
                             </div>
             ...
             <div class="col-xl-12">
                 ...
                 <div class="tab-content" id="pills-tabContent">
                     <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                         <div class="row">
                             <div class="col-md-12 mt-3">
                                 <h5>Ranking Polda Data Anev Tertinggi <?= date('d M Y'); ?></h5>
                                 <div class="card shadow-sm">
                                     <table class="table table-bordered table-hover" id="tableAnevDay">
                                         <thead style="background-color:#007DD8; color:#fff;">
                                             <tr class="text-center">
                                                 <th scope="col">No</th>
                                                 <th scope="col">Polda</th>
                                                 <th scope="col">Anev</th>
                                             </tr>
                                         </thead>
                                         <tbody id="tbody-anevDay">
                                         </tbody>
                                     </table>
                                 </div>
                             </div>
                     ...
                     <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                         <div class="row">
                             <div class="col-md-12 mt-3">
                                 <h5>Ranking Polda Data Anev Tertinggi <?= date('M Y'); ?></h5>
                                 <div class="card shadow-sm">
                                     <table class="table table-bordered table-hover" id="tableAnevMonth">
                                         <thead style="background-color:#007DD8; color:#fff;">
                                             <tr class="text-center">
                                                 <th scope="col">No</th>
                                                 <th scope="col">Polda</th>
                     ...
                     <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                         <div class="row">
                             <div class="col-md-12 mt-3">
                                 <h5>Ranking Polda Data Anev Tertinggi <?= date('Y'); ?></h5>
                                 <div class="card shadow-sm">
                                     <table class="table table-bordered table-hover" id="tableAnevYear">
                                         <thead style="background-color:#007DD8; color:#fff;">
                                             <tr class="text-center">
                                                 <th scope="col">No</th>
                                                 <th scope="col">Polda</th>
 ...
 <script>
     $(document).ready(function() {
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 let polda_anev = result.data.polda_walpjr
                 // Chart Wal pjr Lalu Lintas

                 var chart = {
                     series: [{
                         name: '<h6>Total Anev</h6>',
                         type: 'column',
                         data: polda_anev,
                         color: "#11347A"
                     }],
         ...
         topAnevDay(yesterday);
         topAnevMonth(firstDayMonth, lastDayMonth);
         topAnevYear(firstDay, lastDay)

         anev_daily(yesterday, firstDayMonth, lastDayMonth, firstDay, lastDay)

         AnevlineChart(seven_daysAgo, yesterday)
         jam();
     })
     ...
     $('#limit_showData').on('change', function() {
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 let polda_id = result.data.polda_id
                 let polda_name = result.data.polda_name
                 let polda_anev = result.data.walpjr
     ...
     function anev_daily(yesterday, firstDayMonth, lastDayMonth, firstDay, lastDay) {
         $.ajax({
             ...
             success: function(result) {
                 console.log(result);
                 $("#overlay").fadeOut(300);
                 $('#AnevThisDay').text(result.thisDay)
                 $('#AnevThisMonth').text(result.thisMonth)
                 $('#AnevThisYear').text(result.thisYear)
     ...
     function ButtonFilter() {
         ...
         if ((start_date != '' && end_date == '') || (start_date == '' && end_date != '')) {
             ...
             AnevlineChart(start_date, end_date)
         }
     }

     function AnevlineChart(seven_daysAgo, yesterday) {
