     ...
     <div class="card mt-5 p-1 shadow" style="border-radius:36px !important;">
         <div class="row m-2">
             <div class="col-sm-4 col-md-5 align-self-center">
                 <h2>DATA <span style="text-transform:uppercase ; color:#2e93e6">Renop <span style="color:#000;">Polda&nbsp;<?= $data['poldaid']['name_polda']; ?></span></span> </h2>
             </div>
                             ...
                             <div class="card-body p-1">
                                 <div class="row justify-content-between align-items-center" style="height: 80px;">
                                     ...
                                     <div class="col-md-5 float-end">
                                         <h1 class="text-center mb-0" style="color:#464646; font-size:25px; color:#2e93e6;" id="renopThisDay"></h1>
                                         <p class="text-center mb-0">Renop</p>
                                     </div>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="card p-1 mt-2 mb-2" style="border-radius: 20px !important; border-color:#D9D9D9">
                             <div class="card-body p-1">
                                 <div class="row justify-content-between align-items-center" style="height: 80px;">
                                     ...
                                     <div class="col-md-5 float-end">
                                         <h1 class="text-center mb-0" style="color:#464646; font-size:25px; color:#2e93e6;" id="renopThisMonth"></h1>
                                         <p class="text-center mb-0">Renop</p>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <div class="card p-1 mt-2 mb-2" style="border-radius: 20px !important; border-color:#D9D9D9">
                             <div class="card-body p-1">
                                 <div class="row justify-content-between align-items-center" style="height: 80px;">
                                     ...
                                     <div class="col-md-5 float-end">
                                         <h1 class="text-center mb-0" style="color:#464646; font-size:25px; color:#2e93e6;" id="renopThisYear"></h1>
                                         <p class="text-center mb-0">Renop</p>
                                     </div>
                                 </div>
                             </div>
             ...
             <div class="col-xl-12">
                 ...
                 <div class="tab-content" id="pills-tabContent">
                     <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                         <div class="row">
                             <div class="col-md-12 mt-3">
                                 <h5>Ranking Polda Data Renop Tertinggi <?= date('d M Y'); ?></h5>
                                 <div class="card shadow-sm">
                                     <table class="table table-bordered table-hover" id="tableRenopDay">
                                         <thead style="background-color:#007DD8; color:#fff;">
                                             <tr class="text-center">
                                                 <th scope="col">No</th>
                                                 <th scope="col">Polda</th>
                                                 <th scope="col">Renop</th>
                                             </tr>
                                         </thead>
                                         <tbody id="tbody-renopDay">
                                         </tbody>
                                     </table>
                                 </div>
                             </div>
                     ...
                     <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                         <div class="row">
                             <div class="col-md-12 mt-3">
                                 <h5>Ranking Polda Data Renop Tertinggi <?= date('M Y'); ?></h5>
                                 <div class="card shadow-sm">
                                     <table class="table table-bordered table-hover" id="tableRenopMonth">
                                         <thead style="background-color:#007DD8; color:#fff;">
                                             <tr class="text-center">
                                                 <th scope="col">No</th>
                                                 <th scope="col">Polda</th>
                     ...
                     <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                         <div class="row">
                             <div class="col-md-12 mt-3">
                                 ...
                                 <div class="card shadow-sm">
                                     <table class="table table-bordered table-hover" id="tableRenopYear">
                                         <thead style="background-color:#007DD8; color:#fff;">
                                             <tr class="text-center">
                                                 <th scope="col">No</th>
                                                 <th scope="col">Polda</th>
 ...
 <script>
     $(document).ready(function() {
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 let polda_renop = result.data.polda_walpjr
                 // Chart Wal pjr Lalu Lintas

                 var chart = {
                     series: [{
                         name: '<h6>Total Renop</h6>',
                         type: 'column',
                         data: polda_renop,
                         color: "#11347A"
                     }],
         ...
         topRenopDay(yesterday);
         topRenopMonth(firstDayMonth, lastDayMonth);
         topRenopYear(firstDay, lastDay)

         renop_daily(yesterday, firstDayMonth, lastDayMonth, firstDay, lastDay)

         RenoplineChart(seven_daysAgo, yesterday)
         jam();
     })
     ...
     $('#limit_showData').on('change', function() {
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 let polda_id = result.data.polda_id
                 let polda_name = result.data.polda_name
                 let polda_renop = result.data.walpjr
     ...
     function renop_daily(yesterday, firstDayMonth, lastDayMonth, firstDay, lastDay) {
         $.ajax({
             type: "POST",
             ...
             success: function(result) {
                 console.log(result);
                 $("#overlay").fadeOut(300);
                 $('#renopThisDay').text(result.thisDay)
                 $('#renopThisMonth').text(result.thisMonth)
                 $('#renopThisYear').text(result.thisYear)
     ...
     function ButtonFilter() {
         ...
         if ((start_date != '' && end_date == '') || (start_date == '' && end_date != '')) {
             ...
             RenoplineChart(start_date, end_date)
         }
     }

     function RenoplineChart(seven_daysAgo, yesterday) {
         ...
         $.ajax({
             ...
             success: function(results) {
                 ...
                 var renop = new ApexCharts(document.querySelector("#chart2"), chart2);
                 renop.render();
             }
         })
     }
     ...
     function topRenopDay(yesterday) {
         $.ajax({
             type: "POST",
             ...
             success: function(result) {
                 ...
                 $('#tbody-renopDay').html(table);
                 <?php $mobile = detect_mobile();
                    if ($mobile === true) { ?>

                     $('#tableRenopDay').DataTable({
                         responsive: true,
     ...
     function topRenopMonth(firstDayMonth, lastDayMonth) {
         $.ajax({
             type: "POST",
             ...
             success: function(result) {
                 ...
                 $('#tbody-renopMonth').html(table);
                 <?php $mobile = detect_mobile();
                    if ($mobile === true) { ?>

                     $('#tableRenopMonth').DataTable({
                         responsive: true,
     ...
     function topRenopYear(firstDay, lastDay) {
         $.ajax({
             type: "POST",
             ...
             success: function(result) {
                 ...
                 $('#tbody-renopYear').html(table);
                 <?php $mobile = detect_mobile();
                    if ($mobile === true) { ?>

                     $('#tableRenopYear').DataTable({
                         responsive: true,
