			...
			<div class="row align-items-center mt-5">
				...
				<div class="col-md-10">
					<div class="row">
						...
						<div class="col-md-2">
							<a href="<?= base_url('executive/Satker_executive/ditregident'); ?>"><button class="btn btn-primary text-uppercase fw-bold" style="width: 100%; background-color:#007DD8;">Ditregident</button></a>
						</div>
						<div class="col-md-2">
							<a href="<?= base_url('executive/Satker_executive/ditkamsel'); ?>"><button class="btn btn-outline-secondary text-uppercase fw-bold" style="width: 100%; border-color:#464646;">Ditkamsel</button></a>
						</div>
						<div class="col-md-2">
