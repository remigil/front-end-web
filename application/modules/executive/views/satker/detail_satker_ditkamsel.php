...
<body>
                                            ...
                                            <div class="row justify-content-between align-items-center" style="height: 80px;">
                                                ...
                                                <div class="col-md-10 float-end">
                                                    <span class="fs-6 float-end" style="color:#464646;">
                                                        <span class="fw-bold">Data </span>Dikmaslantas
                                                    </span>
                                                    <br>
                                    ...
                                    <div class="card" style="border-radius: 20px !important; background-color:#D9D9D9">
                                        <div class="card-body">
                                            <div class="row justify-content-between align-items-center" style="height: 80px;">
                                                ...
                                                <div class="col-md-10 float-end">
                                                    <span class="fs-6 float-end" style="color:#464646;">
                                                        <span class="fw-bold">Penyebaran </span>& Pemasangan
                                                    </span>
                                                    <br>
                                                    <span class="fs-6 fw-bold float-end" style="color:#464646;" id="penyebaran"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo base_url(); ?>executive/Satker_executive/getDitkamsel",
                dataType: "JSON",
                success: function(result) {
                    console.log(result)
                    $('#dikmaslantas').html(`<span class="fs-4" >${result.data.total_dikmaslantas}</span >`);
                    $('#penyebaran').html(`<span class="fs-4" >${result.data.total_penyebaran}</span >`);
                    ...
                    var ditgakkum = {
                        series: [{
                            name: 'Dikmaslantas',
                            type: 'column',
                            data: result.data.polda_dikmaslantas,
                            color: "#11347A"
                        }, {
                            name: 'Penyebaran',
                            type: 'column',
                            data: result.data.polda_penyebaran,
                            color: "#CB2D3E"
                        }],
                        chart: {
                            height: 400,
