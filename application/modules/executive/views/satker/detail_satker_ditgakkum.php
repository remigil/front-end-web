        ...
        <div class="container-fluid">
			...
			<div class="row align-items-center mt-5">
				...
				<div class="col-md-10">
					<div class="row">
						<div class="col-md-2">
							<a href="<?= base_url('executive/Satker_executive/ditgakkum'); ?>"><button class="btn btn-primary text-uppercase fw-bold" style="width: 100%; background-color:#007DD8;">Ditgakkum</button></a>
						</div>
						<div class="col-md-2">
