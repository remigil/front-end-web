                    ...
                    <div class="card mt-5 p-3 shadow" style="border-radius:36px !important;">
                        <div class="row m-2">
                            <div class="col-md-6 align-self-center">
                                <h1>Data <span style="text-transform:uppercase ; color:#2e93e6">Kecelakaan <span style="color:#000;">Nasional</span></span> </h1>
                            </div>
                            <div class="col-md-6">
                                <div class="row m-2">
                                            ...
                                            <div class="card-body">
                                                <div class="row justify-content-between align-items-center" style="height: 80px;">
                                                    ...
                                                    <div class="col-md-6 float-end">
                                                        <h1 class="text-center" style="color:#464646; font-size:30px; color:#2e93e6;" id="lakaThisDay"></h1>
                                        ...
                                        <div class="card mt-2 mb-2" style="border-radius: 20px !important; border-color:#D9D9D9">
                                            <div class="card-body">
                                                <div class="row justify-content-between align-items-center" style="height: 80px;">
                                                    ...
                                                    <div class="col-md-6 float-end">
                                                        <h1 class="text-center" style="color:#464646; font-size:30px; color:#2e93e6;" id="lakaThisMonth"></h1>
                                                        <p class="text-center">Kejadian</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card mt-2 mb-2" style="border-radius: 20px !important; border-color:#D9D9D9">
                                            <div class="card-body">
                                                <div class="row justify-content-between align-items-center" style="height: 80px;">
                                                    ...
                                                    <div class="col-md-6 float-end">
                                                        <h1 class="text-center" style="color:#464646; font-size:30px; color:#2e93e6;" id="lakaThisYear"></h1>
                                                        <p class="text-center">Kejadian</p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="tab-content" id="pills-tabContent">
                                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                                <div class="row">
                                                    <div class="col-md-12 mt-3">
                                                        <h5>Top 10 Polda Data Kecelakaan Tertinggi <?= date('d M Y', strtotime("-1 days")); ?></h5>
                                            ...
                                            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                                <div class="row">
                                                    <div class="col-md-12 mt-3">
                                                        <h5>Top 10 Polda Data Kecelakaan Tertinggi <?= date('M Y'); ?></h5>
                                                        <div class="card shadow-sm">
                                                            <table class="table table-bordered table-hover">
                                                                <thead style="background-color:#007DD8; color:#fff;">
                                                                    <tr class="text-center">
                                            ...
                                            <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                                                <div class="row">
                                                    <div class="col-md-12 mt-3">
                                                        <h5>Top 10 Polda Data Kecelakaan Tertinggi <?= date('Y'); ?></h5>
                                                        <div class="card shadow-sm">
                                                            <table class="table table-bordered table-hover">
                                                                <thead style="background-color:#007DD8; color:#fff;">
                                                                    <tr class="text-center">
