<?php
class M_detail_statistik_polda extends CI_Model
{
    ...
    // Kecelakaan (Laka)
    public function getKecelakaanPolda($filterbaru)
    {
    ...
    public function getKecelakaanPoldaDate($filterbaru)
    {

        if ($filterbaru['filter'] == 0) {
            $url = 'laka_lantas/date?type=day&polda_id=' . $filterbaru['id'] . '&filter=true&start_date=' . $filterbaru['start_date'] . '&end_date=' . $filterbaru['end_date'] . '';
            $lakalantasnasional = guzzle_request('GET', $url, [
                'headers' => [
                    'Authorization' => $this->session->userdata['token']
                ]
    ...
    public function getGarlantasPoldaDate($filterbaru)
    {

        if ($filterbaru['filter'] == 0) {
            $url = 'garlantas/date?type=day&polda_id=' . $filterbaru['id'] . '&filter=true&start_date=' . $filterbaru['start_date'] . '&end_date=' . $filterbaru['end_date'] . '';
            $lakalantasnasional = guzzle_request('GET', $url, [
                'headers' => [
                    'Authorization' => $this->session->userdata['token']
                ]
    ...
    {
        if ($filterbaru['filter'] == 0) {
            $url = 'sim/date?polda_id=' . $filterbaru['id'] . '&type=day&filter=true&start_date=' . $filterbaru['start_date'] . '&end_date=' . $filterbaru['end_date'] . '';
    ...
    public function getBpkbPoldaDate($filterbaru)
    {

        if ($filterbaru['filter'] == 0) {
            $url = 'bpkb/date?polda_id=' . $filterbaru['id'] . '&type=day&filter=true&start_date=' . $filterbaru['start_date'] . '&end_date=' . $filterbaru['end_date'] . '';
            $lakalantasnasional = guzzle_request('GET', $url, [
                'headers' => [
                    'Authorization' => $this->session->userdata['token']
                ]
    ...
    public function getRanmorNasionalDate($filterbaru)
    {
        ...
        if ($filterbaru['filter'] == 0) {
            $url = 'ranmor/date?type=day&filter=true&polda_id=' . $filterbaru['id'] . '&start_date=' . $filterbaru['start_date'] . '&end_date=' . $filterbaru['end_date'] . '';
            $lakalantasnasional = guzzle_request('GET', $url, [
                'headers' => [
                    'Authorization' => $this->session->userdata['token']
                ]
