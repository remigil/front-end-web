                ...
                <div class="row login-box">
                    <div class="col-lg-8 align-self-center pad-0 form-info">
                        <div class="form-section align-self-center">
                            ...
                            <div>
                                <span class="fw-bolder" style="color:#003A91">Reset Kata Sandi</span><br>
                            ...
                            <form method="post" action="<?php echo base_url(); ?>login/auth" autocomplete="off" id="form_forgotPassword">
                                ...
                                <input style="width: 100%;" name="id" value="<?= $id ?>" placeholder="Kata Sandi Baru" type="hidden" id="id">
                                <div class="material-textfield mb-3">
                                    <input style="width: 100%;" name="kata_sandi" placeholder="Kata Sandi Baru" type="text" id="kata_sandi">
                                    <label class="labelmui">Kata Sandi Baru</label>
                                </div>
                                <div class="material-textfield mb-3">
                                    <input style="width: 100%;" name="re_kata_sandi" placeholder="Ulangi Kata Sandi" type="password" id="re_kata_sandi" class="password">
                                    <label class="labelmui">Ulangi Kata Sandi</label>
                                    <span><i class="fa-solid fa-eye" id="eye"></i></span>
                                </div>
                                <div style="display: grid;">
                                    <button type="button" class="btn btn-lg btn-primary btn-theme mb-3" style="border-radius: 10px; font-size: 16px; background-color: #003A91" id="send_email">Simpan</button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        $('#send_email').on('click', function() {
            ...
            if (kata_sandi == '' || re_kata_sandi == '') {
                ...
                if (kata_sandi != re_kata_sandi) {
                    ...
                    $.ajax({
                        url: '<?= base_url() ?>login/send_reset_password',
                        data: formData,
                        type: 'POST',
                        dataType: 'JSON',
                        contentType: false,
