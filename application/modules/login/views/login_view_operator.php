...
<head>
  <title>K3I - Operator Korlantas</title>
    ...
    <div class="login-2-inner">
      <div class="container">
        <div class="row login-box">
          <div class="col-lg-11 align-self-center pad-0 form-info">
            <div class="form-section align-self-center">
              ...
              <div>
                ...
                <span class="fs-5 fw-bold">Selamat Datang</span>
                <br>
                <span class="fs-5 fw-bold mb-"> Operator Korlantas</span>
                <br>
                <br>
                <!-- <span class="fs-4 fw-bold"> Operator Korlantas</span> -->
              </div>
