    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary ">
                <h5 class="modal-title text-white" id="myLargeModalLabel">Upload Laporan Riset NTMC</h5>
...
<script>
    $(document).ready(function() {
        ...
        userDataTable = $('#datatable').DataTable({
            ...
            ajax: {
                ...
                url: '<?php echo base_url(); ?>inputdata/LaporanRisetNTMC/serverSideTable',
    ...
    $(".form").submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>inputdata/LaporanRisetNTMC/store",
            method: "POST",
            data: formData,
            dataType: 'JSON',
            contentType: false,
    ...
    function hapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo base_url(); ?>inputdata/LaporanRisetNTMC/delete",
                    type: "POST",
                    data: {
                        id
                    },
