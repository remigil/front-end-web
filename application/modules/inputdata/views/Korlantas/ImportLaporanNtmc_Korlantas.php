    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary ">
                <h5 class="modal-title text-white" id="myLargeModalLabel">Import Laporan NTMC</h5>
...
<div class="modal fade FormatFile" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary ">
                <h5 class="modal-title text-white" id="myLargeModalLabel">Format Import Laporan NTMC</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <ul class="list-group">
                    <li class="list-group-item"><button onclick="format(1)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc Dokumentasi Media TV</button></li>
                    <li class="list-group-item"><button onclick="format(2)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc Media Facebook</button></li>
                    <li class="list-group-item"><button onclick="format(3)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc Media Instagram</button></li>
                    <li class="list-group-item"><button onclick="format(4)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc Media Portal Online</button></li>
                    <li class="list-group-item"><button onclick="format(5)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc Media Sosial Ntmc</button></li>
                    <li class="list-group-item"><button onclick="format(6)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc Media Twitter</button></li>
                    <li class="list-group-item"><button onclick="format(7)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc Off Air Program</button></li>
                    <li class="list-group-item"><button onclick="format(8)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc On Air Program Media Sosial</button></li>
                    <li class="list-group-item"><button onclick="format(9)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc On Air Program Online</button></li>
                    <li class="list-group-item"><button onclick="format(10)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc On Air Program TV</button></li>
                    <li class="list-group-item"><button onclick="format(11)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc On Air Radio Ntmc</button></li>
                    <li class="list-group-item"><button onclick="format(12)" id="btn-format" class="btn btn-xs btn-info">Format Import Ntmc Pengaduan</button></li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        userDataTable = $('#datatable').DataTable({
            ...
            ajax: {
                dataType: 'json',
                url: '<?php echo base_url(); ?>inputdata/ImportLaporanNtmc/listof_import_file',
                data: function(data) {
                    $("#overlay").fadeIn(300);
    ...
    $(".form").submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>inputdata/ImportLaporanNtmc/uploadFile",
            method: "POST",
            data: formData,
            dataType: 'JSON',
            contentType: false,
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    dataType:"json",data:{
                        id:id,
                        file_name:file_name
                    },url:"<?php echo base_url(); ?>inputdata/ImportLaporanNtmc/rmfile",
    ...
    function view()
    {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = "<?php echo site_url(); ?>inputdata/ImportLaporanNtmc/view/"+file_name+"";
            }
        });
    }
    ...
    {
        window.location = "<?php echo site_url(); ?>inputdata/ImportLaporanNtmc/format/"+type+"";
    }
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    dataType:"json",data:{
                        ...
                        file_name:file_name,
                        type: type
                    },url:'<?php echo base_url(); ?>inputdata/ImportLaporanNtmc/process',
                    success: function(response) {
                        $("#overlay").fadeOut(300);
                        if (response.status===true) {
                            Swal.fire(
