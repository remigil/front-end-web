...
class M_laporan_riset_ntmc extends CI_Model
{
...

    {
        ...
        $url = 'laporan_media_ntmc/getWeb?serverSide=True&length=' . $rowperpage . '&start=' . $page . '&order=' . $orderFieldRess . '&orderDirection=' . $orderValue . '' . $searchData . '';
        ...
        foreach ($result['data']['data'] as $field) {
            ...
            $row['action']         = ' 
				...
				<a href="' . url_api() . 'laporan_media_ntmc/' . $field['file'] . '" style="background-color:transparent ; border:none" type="button" target="_blank">
