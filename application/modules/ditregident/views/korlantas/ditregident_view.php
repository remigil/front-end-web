<div class="container-fluid">
    <div class="row">
        ...
        <?php } else { ?>
            ...
            <!-- <div class="col-md-2 text-end align-self-center" style="margin-left: -4%; display:none">
                <div class="btn-group">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <center>
                    <img src="<?= base_url('assets/fe/strukturorganisasi/strukturditregident.png'); ?>" alt="" srcset="" width="100%">
                </center>
            </div>
