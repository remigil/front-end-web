            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="card-body green-card mt-2">
                        <div class="row align-items-center text-center">
                            ...
                            <div class="col-md-6">
                                <h1 class="green-card-text text-center"><?= $data['rubentina'] ?></h1>
                            </div>
                        </div>
                    </div>
                    <div class="card-body yellow-card mt-2">
                        <div class="row align-items-center text-center">
                            ...
                            <div class="col-md-6">
                                <h1 class="yellow-card-text text-center"><?= $data['jumlah'] ?></h1>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-8">
                    <div class="top-five-headline">
                        <h2 class="text-center">10 RANGKING STNK TERTINGGI</h2>
                    </div>
                    <div class="mt-5">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Data STNK Indonesia</h4>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        var polda_rubentina = JSON.parse('<?= json_encode($data['polda_rubentina']); ?>');
        ...
        var month_rubentina = JSON.parse('<?= json_encode($data['month_rubentina']); ?>');
