        ...
        <div class="col-md-8 align-self-center">
            <div id="nama">
                <div style="display: flex;">
                    ...
                    &nbsp;&nbsp; <h3 style="text-transform: uppercase; color:#007DD8;"> SUBDITREGIDENT POLDA <?= $data['poldaid']['name_polda']; ?> </h3>
...
<script>
    ...
    function getStatistik() {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ditregident/subditregident/getStatistik/" + polda_id,
            dataType: "JSON",
    ...
    function getRegidentday(today, seven_daysAgo) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ditregident/subditregident/getChartSim/" + polda_id,
            data: {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ditregident/subditregident/getChartBpkb/" + polda_id,
            data: {
                start_date: seven_daysAgo,
                end_date: today,
                filter: 'day'
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ditregident/subditregident/getChartStnk/" + polda_id,
            data: {
                start_date: seven_daysAgo,
                end_date: today,
                filter: 'day'
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ditregident/subditregident/getChartSbst/" + polda_id,
            data: {
                start_date: seven_daysAgo,
                end_date: today,
                filter: 'day'
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ditregident/subditregident/getChartRanmor/" + polda_id,
            data: {
                start_date: seven_daysAgo,
                end_date: today,
                filter: 'day'
