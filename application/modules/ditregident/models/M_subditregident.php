...
class M_subditregident extends CI_Model
{
    ...
    {
        $url = 'ranmor/date?polda_id=' . $filter['id'] . '&type=' . $filter['type']  . '&filter=true'  . '&start_date=' . $filter['start_date'] . '&end_date=' . $filter['end_date'] . '';
    ...
    {
        $url = 'ditregident/sbst/date?polda_id=' . $filter['id'] . '&type=' . $filter['type']  . '&filter=true'  . '&start_date=' . $filter['start_date'] . '&end_date=' . $filter['end_date'] . '';
    ...
    {
        $url = 'sim/date?polda_id=' . $filter['id'] . '&type=' . $filter['type']  . '&filter=true'  . '&start_date=' . $filter['start_date'] . '&end_date=' . $filter['end_date'] . '';
    ...
    {
        $url = 'bpkb/date?polda_id=' . $filter['id'] . '&type=' . $filter['type']  . '&filter=true'  . '&start_date=' . $filter['start_date'] . '&end_date=' . $filter['end_date'] . '';
    ...
    {
        $url = 'stnk/date?polda_id=' . $filter['id'] . '&type=' . $filter['type']  . '&filter=true'  . '&start_date=' . $filter['start_date'] . '&end_date=' . $filter['end_date'] . '';
