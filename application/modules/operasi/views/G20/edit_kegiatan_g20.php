                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <input type="file" name="photo" class="dropify" data-allowed-file-extensions="jpg png jpeg" <?php if ($data['getDetail']['data']['photo_schedule'] != null) { ?> data-default-file="<?php echo url_api(); ?>schedule/<?php echo $data['getDetail']['data']['photo_schedule']; ?>" <?php } else { ?> data-default-file="<?php echo base_url(); ?>assets/no_image.png" <?php } ?> />
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="material-selectfield mb-3">
                                    <select required name="id_category" id="id_category" style="height: 200px;">
                                        ...
                                        <?php foreach ($data['getCategorySchedule'] as $row) : ?>
                                            <option <?php if ($data['getDetail']['data']['id_category_schedule'] != null) { ?> <?php echo ($row['name_category_schedule'] == $data['getDetail']['data']['category_schedule']['name_category_schedule'] ? 'selected' : ''); ?> <?php } ?> value="<?php echo $row['id']; ?>"><?php echo $row['name_category_schedule']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
