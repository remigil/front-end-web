    ...
    <div class="card">
        <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="material-textfield mb-3">
                                ...
                                <label class="labelmui">Nama Kegiatan</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="material-textfield mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="material-selectfield mb-3">
                                <select class="form-select" name="" id="">
                                    <option value="">Kijang 1</option>
                                    <option value="">Kijang 2</option>
                                    <option value="">Kijang 3</option>
                                    <option value="">Kijang 4</option>
                                </select>
            ...
            <div class="col-12 mb-3">
                <a href="<?= base_url('operasi/Kegiatan'); ?>"><button class="btn btn-sm btn-primary float-end w-25" style="height:5vh ;">Kembali</button></a>
            </div>
        </div>
    </div>
