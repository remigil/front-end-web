...
class Akun extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $getOfficer = guzzle_request('GET', 'officer?serverSide=True&order=name_officer&orderDirection=asc&length=5000&start=1', [
            'headers' => $headers
        ]);
    ...
    public function GetPetugas()
    {
        ...
        $getOfficer = guzzle_request('GET', 'officer?serverSide=True&order=id&orderDirection=desc&length=5000&start=1', [
            'headers' => $headers
        ]);
        $data = $getOfficer['data']['data'];
        $getpetugas = array_filter($data, function ($get) {
