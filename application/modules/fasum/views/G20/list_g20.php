...
<!-- </div> -->
<div class="page">
    <button type="button" class="btn btn-primary waves-effect" data-bs-toggle="modal" data-bs-target=".TambahFasum">Tambah Data</button>
    <div class="card mt-3">
        <div class="card-body">
            <table id="datatable" class="table dt-responsive  nowrap w-100">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Kontak</td>
                        <td>Jam Buka</td>
                        <td><a href='ListFasum/Detail'><button class="btn btn-sm btn-primary"><i class="mdi mdi-cog "></i></button></a>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="<?= $csrf_name;?>" value="<?= $csrf_token;?>" style="display: none">
                    <div class="material-textfield mb-3">
                        <input style="width: 100%;" name="namaAkun" placeholder="" type="text">
                        <label class="labelmui">Nama Fasilitas</label>
                    </div>
                    <div class="material-textfield mb-3">
                        <input style="width: 100%;" name="" placeholder="" type="text">
                        <label class="labelmui">Kontak</label>
                    </div>
                    <div class="material-textfield mb-3">
                        <input style="width: 100%;" name="" placeholder="" type="text">
                        <label class="labelmui">Jam Buka</label>
                    </div>
                    <div class="material-textfield mb-3">
                        <input style="width: 100%;" name="ketuaTeam" placeholder="" type="text">
