...
<nav aria-label="breadcrumb" style="--bs-breadcrumb-divider: '/'; margin-left:-15px; ">
    <ol class="breadcrumb shadow-sm">
        <!-- <li class="breadcrumb-item"><a href="#"><?= $title; ?> - Data Perjalanan Masyarakat Pengguna Jalan Secara Real Time Untuk Memantau Kondisi Lalu Lintas </a></li> -->
        <li class="breadcrumb-item"><a href="#"><?= $title; ?> - Data Perjalanan Penduduk Untuk Meningkatkan Keamanan Wilayah Kota Bogor </a></li>
...
<script>
    ...
    $('#btn_pilih').on('click', function(e) {
        ...
        if (type_filter == 'today') {
            ...
            getPieNgawas(filter, time = false, start_time = null, end_time = null, start_date, end_date, start_date, end_date);
            getStatistikNgawas(filter, time = false, start_time = null, end_time = null, start_date, end_date, start_date, end_date);
            getStatistikNgawas2(filter, time = false, start_time = null, end_time = null, start_date, end_date, start_date, end_date);
            getModelKendaraan(filter, time = false, start_time = null, end_time = null, start_date, end_date, start_date, end_date);
        ...
        $.ajax({
            ...
            success: function(results) {
                ...
                var keberangkatan = {
                    ...
                    xaxis: {
                        categories: results.provinsi.map(provinsi => provinsi.replace('Kecamatan', '')),
                        labels: {
                            show: true,
                            rotate: -45,
                            rotateAlways: false,
    ...
    function getStatistikNgawas2(filter = null, time = null, start_time = null, end_time = null, start_date = null, end_date = null) {
        $.ajax({
            ...
            success: function(results) {
                ...
                var jumlah = results.jumlah
                var jumlah_kendaraan = jumlah.reduce((a, b) => a + b, 0)
                // console.log(jumlah_kendaraan);
                // var keberangkatan = results.keberangkatan
                // var jumlah_keberangkatan = keberangkatan.reduce((a,b)=> a+b, 0)

                $('#jml_tripon').text(`${jumlah_kendaraan}`)
                $('#jml_kendaraan').text(`${jumlah_kendaraan}`)
