            ...
            <div class="col-sm-6 col-md-6">
                <div class="row m-2">
                    ...
                    <div class="col-md-6 col-sm-6 col-xl-6 align-self-center ">
                        <a href="<?php echo base_url('executive/Polda_executive/statistik_polda'); ?>" class="text-center ">
                    ...
                    <div class="col-md-6 col-sm-6 col-xl-6 align-self-center">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" style="width: 100%; z-index: 10000;">
                                ...
                                <a class="dropdown-item fs-4" href="../../ditgakkum/subditgakkum ?>">Subditgakkum Polda</a>
                                <a class="dropdown-item fs-4" href="../../ditregident/subdiregident ?>">Subditregident Polda</a>
                                <a class="dropdown-item fs-4" href="../../ditkamsel/subditkamsel ?>">Subdikamsel Polda</a>
                                <a class="dropdown-item fs-4" href="../../bagrenim/subbagrenmin ?>">Subbagrenmin Polda</a>
                                <a class="dropdown-item fs-4" href="../../bagops/subbagops ?>">Subbagops Polda</a>
                                <a class="dropdown-item fs-4" href="../../bagtik/subbagtik ?>">Subbagtik Polda</a>
                            </div>
                        </div>
                    </div>
                </div>
