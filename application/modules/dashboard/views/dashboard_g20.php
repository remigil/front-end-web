                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-heading3">
                            <button class="accordion-button fw-medium collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse3" aria-expanded="false" aria-controls="flush-collapse3">
                                Petugas
                            </button>
                        </h2>
    ...
    $(document).ready(function() {
                    ...
                    if (ress.length > 0) {
                        for (let i = 0; i < ress.length; i++) {
                            ...
                            if (markerArray[ress[i].id_officer] != null) {
                                markerArray[ress[i].id_officer].setLatLng([ress[i].latitude, ress[i].longitude], {
                                    icon: L.divIcon({
                                ...
                                markerArray[ress[i].id_officer] = L.marker([ress[i].latitude, ress[i].longitude], {
                                    icon: L.divIcon({
                                        // className: 'location-pin',
                                        html: jenis,
                                        iconSize: [5, 5],
        ...
        socket.on('from server', function(ress) {
            ...
            if (markerArray[ress.id_officer] != null) {
                markerArray[ress.id_officer].setLatLng([ress.latitude, ress.longitude], {
                    icon: L.divIcon({
                        className: 'location-pin',
                    ...
                    if (ressCctv && ressCctv.length > 0) {
                        ...
                        if (filterCctv.length > 0) {
                            for (let i = 0; i < filterCctv.length; i++) {
                                ...
                                markerCCTV[i] = L.marker([latitudeCCTV, longitudeCCTV], {
                                    icon: L.divIcon({
                                        // className: 'location-pin',
                    ...
                    if (ressSchedule && ressSchedule.length > 0) {
                        ...
                        if (filterSchedule.length > 0) {
                            for (var i = 0; i < filterSchedule.length; i++) {
                                ...
                                markerJadwal[i] = L.marker([latitudeJadwal, longitudeJadwal], {
                                    icon: L.divIcon({
                                        // className: 'location-pin',
