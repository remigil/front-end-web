...
class Dashboard extends MY_Controller
{
    ...
    { 
        ...
        $url = 'schedule?serverSide=True&order=date_schedule&orderDirection=asc&length=5&start=1&filter%5B%5D=id_category_schedule&filterSearch%5B%5D='.$input['id_category_schedule'].'';
