...
class Dashboard extends MY_Controller
{
    ...
    public function getJadwalId()
    {
        ...
        $url = 'schedule?serverSide=True&order=date_schedule&orderDirection=asc&length=20&start=1&filter%5B%5D=id_category_schedule&filterSearch%5B%5D='.$input['id_category_schedule'].'';
