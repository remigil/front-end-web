<nav aria-label="breadcrumb" style="--bs-breadcrumb-divider: '/'; margin-left:-15px; ">
    <ol class="breadcrumb shadow-sm">
        ...
        <!-- <li class="breadcrumb-item">Blankspot</li> -->
        <li class="breadcrumb-item active fw-bold" aria-current="page">Detail Blankspot</li>
    </ol>
</nav>
<div class="page">
<div class="row"> 
<div class="col-md-12 mb-2">
                    <a href="<?php echo base_url()?>blankspot/Blankspot/Edit/<?php echo $data['getDetail']['data']['id'];?>"> <button type="button" class=" btn btn-primary waves-effect float-end" style="width: 15%;">Edit <i class="mdi mdi-square-edit-outline"></i></button></a>
                </div>
<div class="card">
<!-- <div class="col-md-12"> -->
<div class="card-body" style="padding: 10px;">
        ...
        <div class="col-md-12" >
            ...
            <div class="col-md-12 mt-3 mb-3">
                <h3 style="font-variant: all-petite-caps;">Detail Data Blankspot</h3>
            </div>
            ...
            <div class="col-md-12 ">
                <div>
                    ...
                    <div class="mt-3" style="font-size: 13px; border:1px solid black; border-radius: 0.25rem; padding: 15px;">
                        ...
                        <div class="row mt-2">
                        <div class="col-md-12 mt-3">
                            <div id="mapG20Blankspot" style="height: 350px"></div>
                        </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-md-3 text-left">
            ...
            <div class="col-md-12  mt-3 mb-3"> 
                <div style="display: flex;text-align: center;align-content: end;float: inline-end;margin-right: 10px;">
                    <a class="btn btn-primary" style="width: 200px;" href="<?php echo base_url()?>blankspot">Kembali</a>
                </div>
            </div>
...
<script>
  ...
  $(document).ready(function() {  
    ...
    // StART MAP SECTION
    var mapContainer = L.map('mapG20Blankspot', {
        maxZoom: 20,
        minZoom: 1,
        zoomSnap: 0.25,
        zoomControl: false,
