...
<div class="page">
    ...
    <!-- <a href="<?= base_url('blankspot/Tambah'); ?>"><button class="btn btn-sm btn-primary" type="button" style="height: 6vh;">Tambah Blankspot</button></a> -->
    <button type="button" class="btn btn-primary waves-effect mb-2" data-bs-toggle="modal" data-bs-target=".TambahBlankspot">Tambah Blankspot</button>
    <div class="card mt-2">
        <div class="card-body">
...
<div class="modal fade TambahBlankspot" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary ">
                <h5 class="modal-title text-white" id="myLargeModalLabel">Tambah Blankspot</h5>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#polda').change(function() {
            ...
            console.log(id);
            $.ajax({
                url: '<?= base_url() ?>blankspot/Blankspot/GetPolres/' + id,
                method: 'post',
                dataType: 'json',
        ...
        var userDataTable = $('#datatable').DataTable({
            ...
            ajax: {
                ...
                url: '<?php echo base_url(); ?>blankspot/Blankspot/serverSideTable',
        ...
        $(".form").submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>blankspot/Blankspot/store",
                method: "POST",
                data: formData,
                dataType: 'JSON',
                contentType: false,
