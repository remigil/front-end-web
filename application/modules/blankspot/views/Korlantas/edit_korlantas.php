...
<div class="page">
    <div class="card">
        ...
        <form class="form" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                    <div class="col-md-12">
                        <a href="<?= base_url('blankspot/Blankspot'); ?>" class="btn btn-primary waves-effect float-end ms-4" style="width: 25%;">Kembali</a> 
                    </div>
                            <div class="col-md-6">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".form").submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo base_url();?>blankspot/Blankspot/storeEdit",
                method: "POST",
                data: formData,
                dataType: 'JSON',
                contentType: false,
                ...
                success: function (data) {
                    ...
                    if(data['status'] == true){
                        ...
                        'success'
                            ...
                            window.location.href = "<?php echo base_url();?>blankspot/Blankspot";
                        }); 
                    }else{
                        Swal.fire(
                        `${data['message']}`, 
    ...
    $("#delete").on('click', function(e) {
        ...
        e.preventDefault();  
        $.ajax({
            url: "<?php echo base_url();?>blankspot/Blankspot/delete",
            method: "POST",
            data: {
                "id": $(this).data("id"),
            },
