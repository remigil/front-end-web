        ...
        <div class="col-md-8 align-self-center">
            <div id="nama">
                <div style="display: flex;">
                    ...
                    &nbsp;&nbsp; <h3 style="text-transform: uppercase; color:#007DD8;"> SUBDITGAKKUM POLDA <?= $data['poldaid']['name_polda']; ?> </h3>
...
<script>
    ...
    function getStatistik(id) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ditgakkum/subditgakkum/getStatistik/" + id,
            dataType: "JSON",
    ...
    getDitgakkumday(today, seven_daysAgo, id)
    getDitgakkummonth(firstDay, lastDay, id)
    getDitgakkumyear(three_yearAgo, lastDay, id)
    // Day
    function getDitgakkumday(today, seven_daysAgo, id) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ditgakkum/subditgakkum/getChartDitgakkum/" + id,
            data: {
    ...
    // Month
    function getDitgakkummonth(firstDay, lastDay, id) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ditgakkum/subditgakkum/getChartDitgakkum/" + id,
            data: {
    ...
    // Year
    function getDitgakkumyear(three_yearAgo, lastDay, id) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ditgakkum/subditgakkum/getChartDitgakkum/" + id,
            data: {
