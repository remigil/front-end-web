...
class M_ditgakkum extends CI_Model
{
    ...
    public function get_datatables_harian($postData = null)
    {
        ...
        $url = 'import/list?filter%5B%5D=jenis_satker&filterSearch%5B%5D=1&serverSide=True&length=' . $rowperpage . '&start=' . $page . '&order=' . $orderFieldRess . '&orderDirection=' . $orderValue . '' . $searchData . '';
