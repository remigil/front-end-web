...
class M_subditgakkum extends CI_Model
{
    ...
    {
        $url = 'laka_lantas/date?polda_id=' . $filter['id'] . '&type=' . $filter['type']  . '&filter=true'  . '&start_date=' . $filter['start_date'] . '&end_date=' . $filter['end_date'] . '';
    ...
    {
        $url = 'garlantas/date?polda_id=' . $filter['id'] . '&type=' . $filter['type']  . '&filter=true'  . '&start_date=' . $filter['start_date'] . '&end_date=' . $filter['end_date'] . '';
    ...
    {
        $url = 'turjagwali/date?polda_id=' . $filter['id'] . '&type=' . $filter['type']  . '&filter=true'  . '&start_date=' . $filter['start_date'] . '&end_date=' . $filter['end_date'] . '';
