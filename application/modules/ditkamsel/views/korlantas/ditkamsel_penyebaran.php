            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="item-card blue-card m-2">
                        <h4 class="text-light ps-2 d-inline fw-light">Spanduk</h4>
                    </div>
                    <div class="item-card red-card m-2">
                        <h4 class="text-light ps-2 d-inline fw-light">Leaflet</h4>
                    </div>
                    <div class="item-card green-card m-2">
                        <h4 class="text-light ps-2 d-inline fw-light">Stiker</h4>
                    </div>
                    <div class="item-card yellow-card m-2">
                        <h4 class="text-light ps-2 d-inline fw-light">Bilboard</h4>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="top-five-headline">
                        <h2 class="text-center">5 RANGKING PENYEBARAN DAN PEMASANGAN TERTINGGI</h2>
                    </div>
                    <div class="mt-5">
