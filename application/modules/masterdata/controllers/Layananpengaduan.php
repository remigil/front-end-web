...
class Layananpengaduan extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('masterdata/m_layananpengaduan');
    }
    ...
    public function index()
    {
        ...
        $page_content["css"] = '';
        $page_content["js"] = '';
        $page_content["title"] = "Layanan Pengaduan";

		$page_content["page"] = "masterdata/Korlantas/layananpengaduan_view";
    ...
    public function serverSideTable()
    {
        ...
        $data = $this->m_layananpengaduan->get_datatables($postData);
		// var_dump($data);
		// die;
	...
	public function detail()
    {
        ...
        $getDetail = guzzle_request('GET', 'complaint/getId/' . $id . '', [
            'headers' => $headers
        ]);
