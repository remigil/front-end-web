...
<div class="page">
    <button type="button" class="btn btn-primary waves-effect mb-2" id="btnTambah" data-bs-toggle="modal"
        data-bs-target=".TambahSatker">Tambah Fungsi Lain</button>
    <div class="card">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary ">
                <h5 class="modal-title text-white" id="myLargeModalLabel">Tambah Fungsi Lain</h5>
            ...
            <div class="modal-body">
                <form action="" class="form row" id="form_tambah" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="nama" name="name_fungsi">
                            <label for="name_fungsi">Nama Fungsi</label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Full Name" name="fullname_fungsi">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Email" name="email_fungsi">
                            <label for="email_fungsi">Email</label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="No Telpon" name="phone_fungsi">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Alamat" name="address_fungsi">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Facebook" name="facebook_fungsi">
                            <label for="facebook_fungsi">Facebook</label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Twitter" name="twitter_fungsi">
                            <label for="twitter_fungsi">Twitter</label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Instagram" name="instagram_fungsi">
                            <label for="instagram_fungsi">Instagram</label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Youtube" name="youtube_fungsi">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Website" name="website_fungsi">
    ...
    $(document).ready(function () {
        ...
        userDataTable = $('#datatable').DataTable({
            ...
            ajax: {
                ...
                url: '<?php echo base_url(); ?>masterdata/Fungsilain/serverSideTable',
        ...
        $(".form").submit(function (e) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>masterdata/Fungsilain/store",
                method: "POST",
                data: formData,
                dataType: 'JSON',
                contentType: false,
    ...
    function hapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo base_url(); ?>masterdata/Fungsilain/hapus/",
                    type: "POST",
                    data: {
                        id: id
                    },
