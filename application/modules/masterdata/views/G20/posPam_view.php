...
<!-- </div> -->
<div class="page">
    <button type="button" class="btn btn-primary waves-effect mb-2" id="btnTambah" data-bs-toggle="modal" data-bs-target=".TambahFasum">Tambah POS PAM</button>
    <div class="card">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="myLargeModalLabel" style="color:white">Tambah POS PAM</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                ...
                                <label for="namaFasum">Nama POS PAM</label>
                            </div>
                        </div>
                        <input hidden type="text" class="form-control" placeholder="nama fasum" value="18" name="jenisFasum"> 
					...
					<div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                ...
                                <label for="">Deskripsi POS PAM</label>
                            </div>
                        </div>
                    </div>
					<div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                ...
                                <label for="kontakFasum">Kontak POS PAM</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                        	<div class="form-floating mb-3">
...
<div class="modal fade DetailFasum" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="myLargeModalLabel" style="color:white">Detail POS PAM</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
					...
					<div class="row">
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                ...
                                <label for="deskripsi">Deskripsi POS PAM</label>
                            </div>
                        </div>
                    </div>
					<div class="row">
...
<div class="modal fade UbahFasum" id="myModalEdit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="myLargeModalLabel" style="color:white">Edit POS PAM</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
