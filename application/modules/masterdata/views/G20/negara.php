...
<div class="modal fade Tambahnegara" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    $(document).ready(function() {
        ...
        var userDataTable = $('#datatable').DataTable({ 
            ...
            ajax : {
                ...
                url: '<?php echo base_url();?>masterdata/negara/serverSideTable',
        ...
        $(".form").submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo base_url();?>masterdata/negara/store",
                method: "POST",
                data: formData,
                dataType: 'JSON',
                contentType: false,
