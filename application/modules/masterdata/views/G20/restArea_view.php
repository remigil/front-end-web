...
<!-- </div> -->
<div class="page">
    <button type="button" class="btn btn-primary waves-effect mb-2" id="btnTambah" data-bs-toggle="modal" data-bs-target=".TambahFasum">Tambah Rest Area</button>
    <div class="card">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="myLargeModalLabel" style="color:white">Tambah Rest Area</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                ...
                                <label for="namaFasum">Nama Rest Area</label>
                            </div>
                        </div>
                        <input hidden type="text" class="form-control" placeholder="nama fasum" value="4" name="jenisFasum">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                ...
                                <label for="">Deskripsi Rest Area</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                ...
                                <label for="kontakFasum">Kontak Rest Area</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
...
<div class="modal fade DetailFasum" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="myLargeModalLabel" style="color:white">Detail Rest Area</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                ...
                                <label for="deskripsi">Deskripsi Rest Area</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<div class="modal fade UbahFasum" id="myModalEdit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="myLargeModalLabel" style="color:white">Edit Rest Area</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="" class="form" id="form_edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="namaFasum" name="namaFasum">
                                <label for="">Nama Rest Area</label>
                            </div>
                        </div>
                        <input hidden type="text" class="form-control" placeholder="nama fasum" value="4" name="jenisFasum">
                        <input hidden type="text" class="kilometres" name="kilometres" placeholder="15" value="0" />
