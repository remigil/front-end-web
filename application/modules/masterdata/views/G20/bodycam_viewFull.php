...
<body style="background-color: #f5f3f4;">
                        ...
                        <div class="accordion-item" id="clickRoad">
                            <h2 class="accordion-header" id="flush-headingOne">
                                <button class="accordion-button fw-medium" type="button" data-bs-toggle="collapse"
                                    ...
                                    BodyCam MAINROAD &nbsp;<span class="badge bg-danger rounded-pill" id="tlistMainroad"></span>
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item" id="clickGerbang">
                            <h2 class="accordion-header" id="flush-headingTwo">
                                <button class="accordion-button fw-medium collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    BodyCam GERBANG &nbsp;<span class="badge bg-danger rounded-pill" id="tlistGerbang"></span>
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item" id="clickEthle">
                            <h2 class="accordion-header" id="flush-heading4">
                                <button class="accordion-button fw-medium collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    BodyCam ETLE &nbsp;<span class="badge bg-danger rounded-pill" id="tlistEthle"></span>
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item" id="clickCctv">
                            <h2 class="accordion-header" id="flush-heading6">
                                <button class="accordion-button fw-medium collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    BodyCam &nbsp;<span class="badge bg-danger rounded-pill" id="tlistCctv"></span>
                                </button>
                            </h2>
            ...
            <div class="container-fluid">
                    ...
                    <!-- <nav aria-label="breadcrumb" style="--bs-breadcrumb-divider: '/'; margin-left:0px; ">
                        <ol class="breadcrumb shadow-sm">
                            <li class="breadcrumb-item"><a href="<?= base_url()?>masterdata/bodycam/">List Data BodyCam</a></li>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            <nav aria-label="breadcrumb" style="--bs-breadcrumb-divider: '/'; margin-left:0px; margin-top: 5px; ">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= base_url()?>masterdata/bodycam/">List Data BodyCam Bali</a></li>
                                    <li class="breadcrumb-item active fw-bold" aria-current="page">Daftar <?= $title; ?></li>
                                </ol>
                            </nav>
                        </div>
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-end gap-2" style="margin: 5px;">
                                <div>
                                    <ul class="nav nav-pills">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="<?php echo base_url()?>masterdata/bodycam/fullscreen" data-bs-toggle="tooltip" data-bs-placement="top" title="FullScreen"><i class="bx bx bx-fullscreen"></i></a>
                                        </li>
                                    </ul>
                                </div> 
                            </div> 
    ...
    <script>
            ...
            (function () {
                ...
                const draggable = new Dragoned(document.querySelector("#listMainroad"), {
                    ...
                    onEnd: (data) => {
                        ...
                        var filterDummyBodyCam = dummyBodyCam.filter(function (e) {
                                                return e.vms_bodycam == vms;
                                            }); 
                        // console.log(filterDummyBodyCam);
                        

                        if(filterDummyBodyCam.length > 0){
                            
                            if(filterDummyBodyCam[0]['ip_bodycam'] == 'https://balisatudata.baliprov.go.id/peta-bodycam'){
                                resource = `<button onClick="openFull('${filterDummyBodyCam[0]['ip_bodycam']}', '${filterDummyBodyCam[0]['link_bodycam']}', '${filterDummyBodyCam[0]['address_bodycam']}', '${filterDummyBodyCam[0]['type_bodycam']}')" style="position: absolute;margin-bottom: 5px;margin-left: 5px;bottom: 0;" class="btn btn-primary" ><i class="fa fa-eye" ></i></button>
                                ...
                                <iframe id="myIframe"  src="${filterDummyBodyCam[0]['link_bodycam']}" style="width: 100%; height: 100%;"   ></iframe>`;
                            }else{
                                resource = `<button onClick="openFull('${filterDummyBodyCam[0]['ip_bodycam']}', '${filterDummyBodyCam[0]['link_bodycam']}', '${filterDummyBodyCam[0]['address_bodycam']}', '${filterDummyBodyCam[0]['type_bodycam']}')" style="position: absolute;margin-bottom: 5px;margin-left: 5px;bottom: 0;" class="btn btn-primary" ><i class="fa fa-eye" ></i></button>
                                <button onClick="deleteView(this, '${no}')" style="position: absolute;margin-bottom: 5px;margin-left: 55px;bottom: 0;" class="btn btn-danger" ><i class="fa fa-trash" ></i></button>
                                <img style="width: 100%; height: 100%;"  src="${filterDummyBodyCam[0]['link_bodycam']}"/>`;
                            } 
                        }else{
                            resource = ``;
        ...
        function serverSideGetBodyCam(){
            ...
            $.ajax({
                type : "POST",
                url : "<?php echo base_url();?>masterdata/bodycam/getBodyCamFullScreen", 
                data : {
                    "kategoriFilter" : null,
                    "searchFilter": null,
                    "page": null,
                ...
                success : function(result){   
                    ...
                    if(ress.length > 0){   
                        ...
                        if(ressMainRoad.length > 0){ 
                            if(openMainRoad == false){
                                // $("#clickRoad").on("click", function (e) { 
                                    ...
                                    ressMainRoad.forEach(el => {
                                        ...
                                        listSideBodyCam += `   
                                            <div data-type="text" data-vms="${el.vms_bodycam}" data-no="${countlistBodyCam}" class="drag-item" style="padding: calc(var(--bs-gutter-x) * 0.1);">
                                                <h5 class="panel-title" style="font-size: 14px;">${countlistBodyCam}. ${el.type_bodycam} - ${el.address_bodycam}</h5>
                                            </div>  
                                        `;
                                        $("#listMainroad").html(listSideBodyCam);  
                                    });  
                                    openMainRoad = true;  
                                // }); 
                            }
                            ...
                            for (let i = 0; i < 12; i++){  
                                if(ress[i]['ip_bodycam'] == 'https://balisatudata.baliprov.go.id/peta-bodycam'){
                                    resource = `
                                    <button onClick="openFull('${ress[i]['ip_bodycam']}', '${ress[i]['link_bodycam']}', '${ress[i]['address_bodycam']}', '${ress[i]['type_bodycam']}')" style="position: absolute;margin-bottom: 5px;margin-left: 5px;bottom: 0;" class="btn btn-primary" ><i class="fa fa-eye" ></i></button>
                                    ...
                                    <iframe id="myIframe" src="${ress[i]['link_bodycam']}" style="width: 100%; height: 100%;"></iframe>`;
                                }else{
                                    resource = `
                                    <button onClick="openFull('${ress[i]['ip_bodycam']}', '${ress[i]['link_bodycam']}', '${ress[i]['address_bodycam']}', '${ress[i]['type_bodycam']}')" style="position: absolute;margin-bottom: 5px;margin-left: 5px;bottom: 0;" class="btn btn-primary" ><i class="fa fa-eye" ></i></button>
                                    <button onClick="deleteView(this, '${i+1}')" style="position: absolute;margin-bottom: 5px;margin-left: 55px;bottom: 0;" class="btn btn-danger" ><i class="fa fa-trash" ></i></button>
                                    <img style="width: 100%; height: 100%;" src="${ress[i]['link_bodycam']}" />`;
                                } 
                                listSideContainer += `
                            ...
                            if(openGerbang == false){
                                // $("#clickGerbang").on("click", function (e) { 
                                    ...
                                    ressMainGerbang.forEach(el => { 
                                        ...
                                        `;
                                        $("#listGerbang").html(listSideBodyCam); 
                                    });  
                            ...
                            if(openEthle == false){
                                // $("#clickEthle").on("click", function (e) { 
                                    ...
                                    ressMainEthle.forEach(el => {
                                        ...
                                        `;
                                        $("#listEthle").html(listSideBodyCam); 
                                    });   
                                // });
                                openEthle = true;
                            }
                            ...
                            if(openBali == false){
                                // $("#clickBaliSatu").on("click", function (e) { 
                                    ...
                                    ressMainBali.forEach(el => {
                                        ...
                                        `;
                                        $("#listBaliSatu").html(listSideBodyCam); 
                                    });   
                                // });
                                openBali = true;
                            }
                        ...
                        //         if(myIp == 'https://balisatudata.baliprov.go.id/peta-bodycam'){
