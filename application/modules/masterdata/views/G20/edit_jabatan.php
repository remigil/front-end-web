    ...
    <div class="card">
        <div class="card-body">
            <form class="form" method="post" enctype="multipart/form-data"> 
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="fs-4 fw-bold">EDIT JABATAN</p>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="material-textfield mb-3">
                                    <input style="width: 100%;" name="name" value="<?php echo $data['getDetail']['data']['name_position'];?>" type="text">
                            ...
                            <div class="col-md-6">
                                <div class="material-selectfield mb-3">
                                    <select class="form-select" name="status">
                                        <option <?php echo ($data['getDetail']['data']['status_position'] == null ? 'selected' : '');?> value="">Pilih Status</option>
                                        <option <?php echo ($data['getDetail']['data']['status_position'] == '1' ? 'selected' : '');?> value="1">Aktif</option>
                                        <option <?php echo ($data['getDetail']['data']['status_position'] == '0' ? 'selected' : '');?> value="0">Tidak Aktif</option>
                                    </select>
                ...
                <div class="col-12 mb-3">
                    <a href="<?= base_url('masterdata/jabatan'); ?>" class="btn btn-sm btn-primary float-end w-25">Kembali</a>
                </div>
            </form> 
        </div>
    </div>
...
<script>
    ...
    $("#delete").on('click', function(e) {
        ...
        e.preventDefault();  
        $.ajax({
            url: "<?php echo base_url();?>masterdata/jabatan/delete",
            method: "POST",
            data: {
                "id": $(this).data("id"),
            },
