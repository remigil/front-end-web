...
class M_stackholder extends CI_Model
{
...

    {
        ...
        $url = 'stackholder?serverSide=True&length=' . $rowperpage . '&start=' . $page . '&order=' . $orderFieldRess . '&orderDirection=' . $orderValue . '' . $searchData . '';
        ...
        foreach ($result['data']['data'] as $field) {
            ...
            $row['action']             = '   
                ...
                <button style="background-color:transparent ; border:none" id="HapusPolda" onclick="addLayanan(`' . $field['id'] . '`)">
					<h3 style="color:#003A91"><i class="mdi mdi-playlist-plus"></i></h3>
				</button>
            ';
