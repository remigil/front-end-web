...
<div class="container margin-top-30">
			...
			<ul style="text-align: justify;">
				<li>
					Alamat Lengkap Korps Lalu Lintas Kepolisian Negara Republik Indonesia
					<ul>
						<li>Jalan MT. Haryono Kavling 37 – 38 Jakarta Selatan, DKI Jakarta 12770</li>
					</ul>
				</li>
				<li>
					Tugas
			...
			<ul>
				<li>
					...
					<ul>
						<li>Unduh Rencana Pembangunan Jangka Panjang Korlantas Polri 2005-2025</li>
					</ul>
				</li>
				<li>
					Rencana Strategis;
					<ul>
						<li>Unduh Rencana Strategis Korlantas Polri 2020-2024</li>
					</ul>
				</li>
				<li>
					RKA/KL
					<ul>
						<li>RKA/KL 2021Unduh</li>
					</ul>
				</li>
				<li>
					Rencana Kerja;
					<ul>
						<li>Unduh Rencana Kerja Tahun 2021</li>
					</ul>
				</li>
				<li>
			...
			<ul>
				<li>
					...
					<ul>
						<li>Laporan Tahunan 2019</li>
						<li>Laporan Tahunan 2018</li>
						<li>Laporan Tahunan 2017</li>
						<li>Laporan Tahunan 2016</li>
						<li>Laporan Tahunan 2015</li>
						<li>Laporan Tahunan 2014</li>
						<li>Laporan Tahunan 2013</li>
						<li>Laporan Tahunan 2012</li>
						<li>Laporan Tahunan 2011</li>
						<li>Laporan Tahunan 2010</li>
					</ul>
				</li>
				<li>
					Laporan Akuntabilitas Kinerja Instansi Pemerintah (LAKIP)
					<ul>
						<li>LKIP 2020 Korlantas Polri</li>
						<li>LAKIP 2019 Korlantas Polri</li>
						<li>LAKIP 2018 Korlantas Polri</li>
						<li>LAKIP 2017 Korlantas Polri</li>
						<li>LAKIP 2016 Korlantas Polri</li>
						<li>LAKIP 2015 Korlantas Polri</li>
						<li>LAKIP 2014 Korlantas Polri</li>
						<li>LAKIP 2013 Korlantas Polri</li>
						<li>LAKIP 2012 Korlantas Polri</li>
						<li>LAKIP 2011 Korlantas Polri</li>
						<li>LAKIP 2010 Korlantas Polri</li>
					</ul>
				</li>
				<li>
					Laporan Keuangan (Audited);
					<ul>
						<li>Laporan Keuangan Tahun Anggaran 2020</li>
						<li>Laporan Keuangan Tahun Anggaran 2019</li>
						<li>Laporan Keuangan Tahun Anggaran 2018</li>
						<li>Laporan Keuangan Tahun Anggaran 2017</li>
						<li>Laporan Keuangan Tahun Anggaran 2016</li>
						<li>Laporan Keuangan Tahun Anggaran 2015</li>
						<li>Laporan Keuangan Tahun Anggaran 2014</li>
						<li>Laporan Keuangan Tahun Anggaran 2013</li>
						<li>Laporan Keuangan Tahun Anggaran 2012</li>
						<li>Laporan Keuangan Tahun Anggaran 2011</li>
						<li>Laporan Keuangan Tahun Anggaran 2010</li>
					</ul>
				</li>
				<li>
					Laporan Barang Milik Negara.
					<ul>
						<li>Laporan BMN Tahun 2020</li>
						<li>Laporan BMN Tahun 2019</li>
						<li>Laporan BMN Tahun 2018</li>
						<li>Laporan BMN Tahun 2017</li>
					</ul>
				</li>
			</ul>
			...
			<h3>Informasi dan Pengaduan</h3>
			<p>deskripsi:</p>
			<p>Informasi mengenai kanal informasi dan pengaduan :</p>
			<ul>
				<li>
					Contact Center NTMC Polri:
					<ul>
						<li>Kanal pengaduan dan informasi melalui sambungan langsung Contact Center (021) 1500669 dan SMS center 9119</li>
						<li>Aplikasi Contact NTMC Polri di Playstore dan App Store.</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						<li>Contact NTMC adalah aplikasi Contact Center NTMC Korlantas Polri untuk memproses pengaduan dan pemberian informasi lalu lintas sehubungan dengan adanya permintaan informasi kondisi lalu lintas terkini, kecelakaan lalu lintas, kemacetan lalu lintas, pelanggaran Rambu Lalu Lintas, adanya Calo, Pungli, Suap dan balap liar yang melanggar peraturan perundang-undangan dan kebijakan bidang lalu lintas.</li>
						<li>layanan penyampaian semua aspirasi dan pengaduan masyarakat Indonesia melalui beberapa kanal pengaduan yaitu website www.korlantas.go.id, SMS 9119 (Telkomsel, Indosat, Three), Twitter, IG, PB serta aplikasi mobile (Android dan iOS).</li>
					</ul>
				</li>
				<li>
					Chatbot K3i Korlantas Polri:
			...
			<ul>
				<li>Laporan Layanan Informasi Publik;</li>
				<li>Laporan Akses Informasi Publik;</li>
				<li>Laporan Survey Kepuasan Layanan Informasi Publik.</li>
			</ul>

			<h3>Daftar Informasi Publik</h3>
			<p>deskripsi:</p>
			<p>Informasi mengenai Daftar Informasi Publik Korlantas Polri</p>
			<ul>
				<li>DIP 2021</li>
				<li>DIP 2020</li>
			</ul>
			...
			<div class="row">
				<div class="col-md-12 text-center mt-5">
					<h5>PPID KORPS LALU LINTAS POLRI</h5>
					<p>
						Korlantas.polri.go.id | Jalan MT. Haryono Kavling 37-38 Jakarta Selatan 12770 | Call Center: (021) 150069 | SMS 9119 | korlantas.polri.go.id <br>
						© Pusat Kendali Koordinasi Komunikasi dan Informasi (K3I) Korlantas Polri 2021
					</p>
