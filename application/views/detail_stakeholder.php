      ...
      <div class="container">
        ...
        <div class="container-fluid mt-5">
			<div class="row">
				...
				<img src="<?= base_url()?>assets/fe/client/kemendagri.png" alt="" width="100%">
				</div>
				<div class="col-md-4">
					<h3><?= $headline?></h3>
					<hr>
					...
					Telp: (021) 3450038, Fax: (021) 3851193, 34830261, 3846430<br>
						Email: <a href="mailto:pusdatin@kemendagri.go.id">pusdatin@kemendagri.go.id</a> 
						Pengaduan: <a href="mailto:pengaduan@kemendagri.go.id">pengaduan@kemendagri.go.id</a> 
					</p>
				</div>
				<div class="col-md-3">
				<p>Website:</p>
					<a href="https://kemendagri.go.id/">https://kemendagri.go.id/</a>
					<p>Social Media:</p>
					<ul class="social-icons margin-top-20">
					<li><a class="facebook" href="https://www.facebook.com/Kemendagri?_rdc=1&_rdr"><i class="icon-facebook"></i></a></li>
						<li><a class="twitter" href="https://twitter.com/kemendagri"><i class="icon-twitter"></i></a></li>
						<li><a class="instagram" href="https://www.instagram.com/kemendagri/?utm_source=ig_embed&ig_rid=db55f016-5d27-4cc0-871b-d925e32c38fb"><i class="icon-instagram"></i></a></li>
						<li><a class="youtube" href="https://www.youtube.com/channel/UCNS2Sv12RNs8qb3OAWJEofA"><i class="icon-youtube"></i></a></li>
					</ul>
				</div>
				<div class="col-md-4">
	  ...
	  <div class="section-title">
		...
		<div class="row margin-top-20">
                            <div class="col-md-8 border-end shadows">
                                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/AqwUPvglBuM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                            <div class="col-md-4">
