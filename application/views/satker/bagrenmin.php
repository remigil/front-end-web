		...
		<div class="gallery-slider swiper">
			<div class="swiper-wrapper align-items-center">
				<div class="swiper-slide">
					...
					<p class="fs-7">Berbincang dengan DirRegident pada RAPAT ANALISA & EVALUASI FUNGSI LANTAS TAHUN 2022.</p>
				...
				<div class="swiper-slide">
					...
					<p class="fs-7">Kombespol Singgamata Kabag Renmin Korlantas Polri</p>
				</div>
				<div class="swiper-slide">
					...
					<p class="fs-7">SERAH TERIMA JABATAN KABAGRENMIN KORLANTAS POLRI, SELASA 11 JAN 2022.</p>
				</div>
				<div class="swiper-slide">
				...
				<div class="swiper-pagination">SERAH TERIMA JABATAN KABAGRENMIN KORLANTAS POLRI, SELASA 11 JAN 2022.</div>
			</div>
		</div>
