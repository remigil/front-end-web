...
<script>
  $(document).ready(function() {
    $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>kontak/getStatistik",
      dataType: "JSON",
      success: function(result) {
        $("#overlay").fadeOut(300);
        var optionsdesign = {
          series: [{
            data: result.design.angka
          }],
          chart: {
            type: 'bar',
            height: 250
          ...
          xaxis: {
            categories: result.design.huruf,
          },
          yaxis: {
            labels: {
              show: false
        ...
        var chartdesign = new ApexCharts(document.querySelector("#chartpenampilan"), optionsdesign);
        chartdesign.render();
        ...
        var optionsinfo = {
          ...
          xaxis: {
            categories: result.convenience.huruf,
          },
          yaxis: {
            labels: {
              show: false
        ...
        var chartinfo = new ApexCharts(document.querySelector("#chartinfo"), optionsinfo);
        chartinfo.render();

        // ==================================================================================
        var optionssajiinfo = {
          series: [{
            data: result.accurate.angka
          }],
          chart: {
            type: 'bar',
            height: 250
          ...
          xaxis: {
            categories: result.accurate.huruf,
          },
          yaxis: {
            labels: {
              show: false
        ...
        var chartsajiinfo = new ApexCharts(document.querySelector("#chartsajiinfo"), optionssajiinfo);
        chartsajiinfo.render();

        // ==================================================================================
        var optionscepat = {
          series: [{
            data: result.fast.angka
          }],
          chart: {
            type: 'bar',
            height: 250
        ...
        var chartcepat = new ApexCharts(document.querySelector("#chartcepat"), optionscepat);
        chartcepat.render();
      }
    })
  })
