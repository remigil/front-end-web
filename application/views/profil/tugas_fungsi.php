			...
			<div class="row">
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-12">
							<h4 class="text-center mt-2 p-2" style="background-color: #003A91; color:white; border-radius:10px; height:30px;">KORLANTAS POLRI MENYELENGGARAKAN FUNGSI</h4>
			...
			<div class="row">
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-12">
						<h4 class="text-center mt-2 p-2" style="background-color: #003A91; color:white; border-radius:10px; height:30px;">DITKAMSEL MENYELENGGARAKAN FUNGSI</h4>
							...
							<ol style="text-align: justify;">
								...
								<li>penetapan norma, standar, pedoman, kriteria, prosedur, sasaran dan arah kebijakan penyelenggaraan manajemen dan rekayasa lalu lintas;</li>
			...
			<div class="row">
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-12">
						<h4 class="text-center mt-2 p-2" style="background-color: #003A91; color:white; border-radius:10px; height:30px;">DITGAKKUM MENYELENGGARAKAN FUNGSI</h4>
				...
				<div class="col-md-4">
					<div class="row">
						<div class="col-md-12">
							...
							<iframe width="100%" height="350" src="https://www.youtube.com/embed/videoseries?list=PLkRjBQuRKlZhr68Y7Q3pYszu3xwwGGEWo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			...
			<div class="row">
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-12">
						<h4 class="text-center mt-2 p-2" style="background-color: #003A91; color:white; border-radius:10px; height:30px;">DITREGIDENT MENYELENGGARAKAN FUNGSI</h4>
				...
				<div class="col-md-4">
					<div class="row">
						<div class="col-md-12">
							...
							<iframe width="100%" height="350" src="https://www.youtube.com/embed/JEFV0P0Oflo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			...
			<div class="row">
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-12">
						<h4 class="text-center mt-2 p-2" style="background-color: #003A91; color:white; border-radius:10px; height:30px;">BAGOPS MENYELENGGARAKAN FUNGSI</h4>
				...
				<div class="col-md-8">
					<div class="row">
						...
						<h4 class="text-center mt-2 p-2" style="background-color: #003A91; color:white; border-radius:10px; height:30px;">BAGRENMIN BERTUGAS</h4>
							...
							<p style="text-align: justify;">menyusun perencanaan strategis, pengelolaan administrasi, menyelenggarakan manajemen logistik, personalia, dan pelaporan pencapaian hasil kinerja serta mengendalikan pelaksanaan RBP bidang lalu lintas, serta sebagai pembina fungsi lalu lintas;</p>
						</div>
						
						<div class="col-md-12">
						<h4 class="text-center mt-2 p-2" style="background-color: #003A91; color:white; border-radius:10px; height:30px;">BAGRENMIN MENYELENGGARAKAN FUNGSI</h4>
			...
			<div class="row">
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-12">
						<h4 class="text-center mt-2 p-2" style="background-color: #003A91; color:white; border-radius:10px; height:30px;">BAGTIK MENYELENGGARAKAN FUNGSI</h4>
