	...
	<div class="tabs-container">
		...
		<div class="tab-content" id="tab2b">
			<div class="row">
				...
				<div class="col-md-6">
					<img src="<?= base_url()?>assets/fe/tugas/img-ditkamsel.jpg" alt="">
				</div>
				<div class="col-md-12">
					<h4>DITKAMSEL MENYELENGGARAKAN FUNGSI</h4>
					<ol style="text-align: justify;">
		...
		<div class="tab-content" id="tab3b">
			<div class="row">
				...
				<div class="col-md-6">
					<img src="<?= base_url()?>assets/fe/tugas/img-ditgakkum.jpg" alt="">
				</div>
				<div class="col-md-12">
					<h4>DITGAKKUM MENYELENGGARAKAN FUNGSI</h4>
					<ol style="text-align: justify;">
		...
		<div class="tab-content" id="tab4b">
			<div class="row">
				...
				<div class="col-md-6">
					<img src="<?= base_url()?>assets/fe/tugas/img-ditregident.jpeg" alt="">
				</div>
				<div class="col-md-12">
					<h4>DITREGIDENT MENYELENGGARAKAN FUNGSI</h4>
					<ol style="text-align: justify;">
		...
		<div class="tab-content" id="tab5b">
			<div class="row">
				...
				<div class="col-md-6">
					<img src="<?= base_url()?>assets/fe/tugas/img-bagops.jpg" alt="">
				</div>
				<div class="col-md-12">
					<h4>BAGOPS MENYELENGGARAKAN FUNGSI</h4>
					<ol style="text-align: justify;">
		...
		<div class="tab-content" id="tab6b">
			<div class="row">
				...
				<div class="col-md-6">
					<img src="<?= base_url()?>assets/fe/tugas/img-bagrenmin.jpg" alt="">
				</div>
				<div class="col-md-12">
					<h4>BAGRENMIN MENYELENGGARAKAN FUNGSI</h4>
					<ol style="text-align: justify;">
		...
		<div class="tab-content" id="tab7b">
			<div class="row">
				...
				<div class="col-md-6">
					<img src="<?= base_url()?>assets/fe/tugas/img-bagtik.jpeg" alt="">
				</div>
				<div class="col-md-12">
					<h4>BAGTIK MENYELENGGARAKAN FUNGSI</h4>
					<ol style="text-align: justify;">
