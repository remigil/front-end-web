...
<div class="row">
	<div class="col-md-2">
		<img src="<?= base_url()?>assets/fe/banner_sambutan_kanan.png" alt="" width="100%" class="p-3">
	</div>
	<div class="col-md-8">
		<!-- Container -->
	...
	<div class="col-md-2">
		<img src="<?= base_url()?>assets/fe/banner_sambutan_kiri.png" alt="" width="100%" class="p-3">
	</div>
</div>
