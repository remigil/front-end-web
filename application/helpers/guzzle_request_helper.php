...
if (!function_exists('guzzle_request')) {
    ...
    { 
        try {
            ...
            // $request = $client->request($method, 'http://34.143.227.90:3020/v1/' . $uri, $body); 
    ...
    function url_api()
    {
        ...
        // return 'http://34.143.227.90:3020/uploads/'; 
    }
...
if (!function_exists('guzzle_requestAnev')) {
    ...
    function guzzle_requestAnev($method, $uri, $body)
    {
        try {
            ...
            // $request = $client->request($method, 'http://34.143.227.90:3020/' . $uri, $body);
            $response = $request->getBody();
            $data = json_decode($response, true);
            return $data;
